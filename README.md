...
This project is an adaptation for BoardGameArena of game Mind Up! edited by Catch Up Games.
...
```
If you use it for another game, replace `afterus` mentions on package.json `build:scss` script and on tsconfig.json `files` property.
