...
$this->ORANGUTANS1 = [ 
    ...
    new LevelCard(138, [
        [new LeftFrame([[1, FLOWER]], false), new ClosedFrame([[[1, ENERGY], PER_TAMARINS]]), new RightFrame([[1, FRUIT]], false)],
    ...
    new LevelCard(143, [
        ...
        [new ClosedFrame([[[1, POINT], PER_TAMARINS]]), new RightFrame([[1, ENERGY]], true)],
    ...
    new LevelCard(148, [
        ...
        [new ClosedFrame([[[1, POINT], PER_TAMARINS]]), new RightFrame([[1, GRAIN], [1, FRUIT]], true)],
        [new LeftFrame([[2, ENERGY]], true)],
    ]),
    new LevelCard(149, [
    ...
    new LevelCard(151, [
        [new ClosedFrame([[1, ENERGY]]), new ClosedFrame([[3, DIFFERENT]], [[2, FRUIT]]), new RightFrame([[1, FLOWER]], false)],
...
$this->CHIMPANZEES1 = [    
    ...
    new LevelCard(156, [
        ...
        [new ClosedFrame([[[1, POINT], PER_TAMARINS]])],
    ...
    new LevelCard(166, [
        ...
        [new ClosedFrame([[[1, POINT], PER_TAMARINS]]), new RightFrame([[1, FLOWER], [1, FRUIT]], true)],
    ...
    new LevelCard(170, [
        [new LeftFrame([[1, FRUIT]], false), new RightFrame([[1, FLOWER]], false)],
        [new ClosedFrame([[1, POINT]]), new ClosedFrame([[3, DIFFERENT]], [[1, POINT]]), new RightFrame([[1, FRUIT]], true)],
        [new LeftFrame([[1, REACTIVATE]], true), new RightFrame([[1, FLOWER], [1, ENERGY]], true)],
    ]),
    new LevelCard(171, [
...
$this->GORILLAS1 = [ 
    ...
    new LevelCard(124, [
        ...
        [new LeftFrame([[2, POINT]], true)],
        [new ClosedFrame([[2, RAGE]]), new RightFrame([[1, GRAIN], [1, ENERGY]], true)],
    ]),
    new LevelCard(125, [
    ...
    new LevelCard(126, [
        [new LeftFrame([[1, FLOWER]], false), new ClosedFrame([[1, FRUIT]]), new ClosedFrame([[3, DIFFERENT]], [[1, GRAIN]])],
...
$this->MANDRILLS1 = [ 
    new LevelCard(101, [
        ...
        [new ClosedFrame([[[1, POINT], PER_TAMARINS]]), new RightFrame([[2, FLOWER]], true)],
    ...
    new LevelCard(113, [
        [new LeftFrame([[1, FRUIT]], false), new RightFrame([[1, FLOWER]], false)],
        [new ClosedFrame([[[1, POINT], PER_TAMARINS]]), new RightFrame([[1, FLOWER]], true)],
        [new LeftFrame([[2, POINT]], true), new RightFrame([[2, FLOWER]], true)],
    ]), 
    new LevelCard(114, [
