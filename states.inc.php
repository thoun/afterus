...
$playerActionsGameStates = [
    ...
    ST_MULTIPLAYER_PHASE1 => [
        ...
        "action" => "stPhase1",
        "possibleactions" => [ "cancelLastMoves" ],
        "transitions" => [
            "next" => ST_END_PHASE1,
        ],
    ],
    ...
    ST_PRIVATE_ACTIVATE_EFFECT => [
        ...
        "possibleactions" => [ "activateEffect", "skipEffect", "cancelLastMove", "cancelLastMoves" ],
        "transitions" => [
    ...
    ST_PRIVATE_BUY_CARD => [
        ...
        "descriptionmyturnOnlyEffect" => clienttranslate('Phase 2 : ${you} can activate an effect'),
        "descriptionmyturnOnlyEnd" => clienttranslate('Phase 2 : ${you} must end your turn'),
        "type" => "private",
        "args" => "argBuyCard",
